...
const styles = StyleSheet.create({
  ...
  headerTitle: {fontSize: 18, fontFamily: FONT.semibold, fontWeight: '600', color: '#424242', flex: 1, marginLeft: 12},
  ...
  chipItemText: {fontSize: 12, fontFamily: FONT.medium, fontWeight: '500', color: '#7E8B97'},
  chipItemActiveText: {color: '#FFF', fontFamily: FONT.semibold, fontWeight: '600'},
  ...
  sectionHeadingText: {fontSize: 14, fontFamily: FONT.semibold, fontWeight: '600', color: '#616161'},
  ...
  orderIdText: {fontSize: 12, fontFamily: FONT.semibold, fontWeight: '600', color: '#424242'},
  timeAgoText: {fontSize: 10, color: '#9AA6B2', fontFamily: FONT.medium, fontWeight: '500'},
  cardBodyRow: {
    flexDirection: 'row',
    alignItems: 'center',
    marginTop: 10,
  ...
  customerNameText: {fontSize: 18, fontFamily: FONT.semibold, fontWeight: '600', color: '#424242'},
  pharmacyRow: {flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 2},
  pharmacyNameText: {fontSize: 12, color: '#616161', fontFamily: FONT.regular, fontWeight: '400'},
  totalText: {fontSize: 13, fontFamily: FONT.semibold, fontWeight: '600', color: '#4E929D'},
  cardFooterRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  phoneText: {fontSize: 11, color: '#5C6470', fontFamily: FONT.medium, fontWeight: '500'},
  ...
  detailModalTitle: {fontSize: 16, fontFamily: FONT.semibold, fontWeight: '600', color: '#1A1C1E'},
  ...
  invoiceBtnText: {fontSize: 12, color: '#4E929D', fontFamily: FONT.semibold, fontWeight: '600'},
  backText: {fontSize: 13, color: '#4E929D', fontFamily: FONT.semibold, fontWeight: '600'},
  ...
  orderInfoLabel: {fontSize: 12, color: '#7E8B97', fontFamily: FONT.medium, fontWeight: '500'},
  orderInfoValue: {fontSize: 12, color: '#1A1C1E', fontFamily: FONT.semibold, fontWeight: '600', maxWidth: '60%', textAlign: 'right'},
  sectionLabel: {fontSize: 13, fontFamily: FONT.semibold, fontWeight: '600', color: '#333D47', marginBottom: 8, marginTop: 4},
  itemsCard: {
    backgroundColor: '#F3F2FB',
    borderRadius: 12,
    borderWidth: 1,
  ...
  itemLineTotal: {fontSize: 13, fontFamily: FONT.semibold, fontWeight: '600', color: '#1A1C1E'},
  timelineCard: {
    backgroundColor: '#F3F2FB',
    borderRadius: 12,
    borderWidth: 1,
  ...
  invoiceValue: {fontSize: 12, color: '#1A1C1E', fontFamily: FONT.medium, fontWeight: '500'},
  invoiceSectionTitle: {fontSize: 13, fontFamily: FONT.semibold, fontWeight: '600', color: '#333D47', marginBottom: 8},
  invoiceItemRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'flex-start',
  ...
  invoiceItemName: {fontSize: 12, fontFamily: FONT.semibold, fontWeight: '600', color: '#1A1C1E'},
  invoiceItemQty: {fontSize: 11, color: '#7E8B97', marginTop: 1},
  invoiceItemTotal: {fontSize: 12, fontFamily: FONT.semibold, fontWeight: '600', color: '#1A1C1E'},
  invoiceTotalRow: {marginTop: 4},
  invoiceTotalLabel: {fontSize: 14, fontFamily: FONT.semibold, fontWeight: '600', color: '#1A1C1E'},
  invoiceTotalValue: {fontSize: 14, fontFamily: FONT.semibold, fontWeight: '600', color: '#4E929D'},
});
